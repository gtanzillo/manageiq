      ...
      unless disks.empty?
        ...
        disks.each do |disk|
          formatted = format(format_string,
                             disk[:filesystem],
                             disk[:type],
                             ApplicationController.new.number_to_human_size(disk[:total_bytes]),
                             ApplicationController.new.number_to_human_size(disk[:used_bytes]),
                             ApplicationController.new.number_to_human_size(disk[:available_bytes]),
